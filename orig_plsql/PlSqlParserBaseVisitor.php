...
/**
 * This class provides an empty implementation of {@see PlSqlParserVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class PlSqlParserBaseVisitor extends AbstractParseTreeVisitor implements PlSqlParserVisitor
{
	/**
	 * {@inheritdoc}
	 *
